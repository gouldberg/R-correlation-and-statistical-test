...
vx <- c(301, 311, 325, 291, 388, 402, 325, 361, 287,
        197, 180, 178, 260, 247, 199, 179, 134, 163, 200,
        209, 331, 192, 155, 234, 290, 175, 116,
        343, 247, 316, 395, 324, 138, 245, 228)
...
# ------------------------------------------------------------------------------
# Levene Test for more than 3 groups
# ------------------------------------------------------------------------------
...
( output <- leveneTest(val ~ group, data = df) )



# ----------
# p.value = 0.087 indicating that Null Hypothesis is NOT REJECTED
